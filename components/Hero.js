...
const Hero = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 px-6 py-6 lg:py-12 overflow-visible"
    >
      ...
      <div className="flex flex-col gap-4 lg:gap-5 items-center text-center lg:text-left lg:items-start relative z-10 lg:flex-1 max-w-2xl">
        {/* Badge */}
        <div className="scroll-animate inline-flex items-center gap-2 px-3 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-300 text-xs font-semibold">
        ...
        <h1 className="scroll-animate font-extrabold text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tight leading-tight text-white">
          Create Surveys{" "}
          <br />
        ...
        <p className="scroll-animate text-base lg:text-lg xl:text-xl text-gray-300 leading-relaxed font-medium">
        ...
        {/* Features List */}
        <div className="scroll-animate flex flex-wrap gap-2">
          <div className="flex items-center gap-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full px-3 py-1.5">
            ...
            <span className="text-white text-xs font-medium">AI Avatars</span>
          </div>
          <div className="flex items-center gap-1.5 bg-pink-500/10 border border-pink-500/30 rounded-full px-3 py-1.5">
            ...
            <span className="text-white text-xs font-medium">Discount Codes</span>
          </div>
          <div className="flex items-center gap-1.5 bg-orange-500/10 border border-orange-500/30 rounded-full px-3 py-1.5">
            ...
            <span className="text-white text-xs font-medium">Custom CTAs</span>
          </div>
          <div className="flex items-center gap-1.5 bg-blue-500/10 border border-blue-500/30 rounded-full px-3 py-1.5">
            ...
            <span className="text-white text-xs font-medium">AI Messages</span>
          </div>
        </div>

        <button 
          onClick={() => router.push(status === "authenticated" ? config.auth.callbackUrl : "/signin")}
          className="scroll-animate bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold text-sm lg:text-base px-6 lg:px-8 py-3 lg:py-4 rounded-2xl hover:scale-105 transition-all duration-300 shadow-xl shadow-purple-500/20 hover:shadow-purple-500/40 inline-flex items-center gap-3 group relative overflow-hidden"
        >
          ...
          <span className="relative flex items-center gap-3">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-4 h-4 lg:w-5 lg:h-5 group-hover:translate-x-2 transition-transform duration-200">
      ...
      <div className="w-full lg:flex-1 scroll-animate relative max-w-2xl">
        ...
        <div className="flex justify-center mb-4 animate-bounce">
          <span className="text-purple-400 font-bold text-xs md:text-sm bg-purple-500/10 px-3 md:px-4 py-1.5 rounded-full border border-purple-500/30">
